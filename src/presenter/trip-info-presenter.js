...
import { sortPointsByDay, getCheckedOffers } from '../utils/common';
...
export default class TripInfoPresenter {
  ...
  #getTripTitle() {
    const destinationNames = this.#pointsModel.points.sort(sortPointsByDay)
      .map((point) => this.#destinationsModel.destinations.find((destination) => destination.id === point.destination).name);
  ...
  #getTripDuration() {
    const sortedPoints = this.#pointsModel.points.sort(sortPointsByDay);
